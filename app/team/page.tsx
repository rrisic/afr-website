    ...
    <main className="min-h-screen bg-black text-white">
      <div className="relative h-screen w-full">
        <div className="absolute inset-0 z-0 mx-4 mb-4">
          <Image
            src="/images/team/full team zot.JPG"
        ...
        <div className="relative z-10 flex h-full items-start justify-center text-center p-4">
          <div className={`text-center ${montserrat.className}`}>
            <div className={`text-center ${montserrat.className}`}>
              <h1 className="m-40 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-4 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] tracking-tight">
                2025–2026 Team (Under Construction)
              </h1>
            </div>
          </div>
        </div>
