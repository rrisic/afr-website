...
import { teamYears, Subteam, TeamMember } from "../data/team";
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto mb-12">
          ...
          <p className="text-lg text-gray-300 text-center">
            Browse previous Anteater Formula Racing teams by season. Below is
            the full roster for the 2024–2025 team.
          </p>
        </div>
        ...
        <div className="space-y-16">
          {teamYears.map((year) => (
            <section
              key={year.id}
              className="bg-gray-900 rounded-lg p-6 md:p-10 shadow-lg"
            >
